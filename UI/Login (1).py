...
"color: rgb(255, 255, 255);")
        ...
        self.resetbutton.setGeometry(QtCore.QRect(630, 630, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"image: url(:/is/3.png);")
        ...
        self.signup.setGeometry(QtCore.QRect(630, 580, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.signup.setFont(font)
        self.signup.setStyleSheet("background-color: rgb(32, 151, 255);\n"
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, LOGIN):
        ...
        self.resetbutton.setText(_translate("LOGIN", "Forgot Password"))
